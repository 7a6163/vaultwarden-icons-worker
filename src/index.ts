...
function fallbackResponse(negativeTtl: number): Response {
  return imageResponse(FALLBACK_ICON, FALLBACK_CONTENT_TYPE, negativeTtl, "fallback");
}
...
async function handleIcon(
  ...
  const response = imageResponse(icon.body, icon.contentType, config.cacheTtl, "miss");
